...
export const GET_NOTE_RATING_MEAN_REQUEST = "GET_NOTE_RATING_MEAN_REQUEST";
export const GET_NOTE_RATING_MEAN_SUCCESS = "GET_NOTE_RATING_MEAN_SUCCESS";
export const GET_NOTE_RATING_MEAN_FAIL = "GET_NOTE_RATING_MEAN_FAIL";
